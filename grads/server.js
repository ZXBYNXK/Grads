...
// Path module
// #4 
// Add Node Core module 'Path' to set the 'views' directory for pug.
...
// #3 
// This creates an instance of an express app 
// The 'app' variable represents the heart of your application it handles all routes, requests, responses, -
// and modifacations you may set using various methods is contains.
const app = express();

// #8 
// load Enviroment Variables from the bash script execution.
...
// #5 
// Set the path for express view engine to a directory containing the views 'views/' then 
...
// #7 
// Set middleware to watch the public directory 
...
// # 10 
// Add imported route instance and connect it as a middleware 
